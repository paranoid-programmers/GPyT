...
@api_v1_router.post("/create-question", response_model=CodeQuestion)
def create_question(user_request: GenerateQuestionRequest):
...
def get_hint(hint_request: GenerateCodeHintRequest) -> GenerateTextResponse:
...
@api_v1_router.post("/give-up")
def give_up(hint_request: GenerateCodeHintRequest) -> GenerateTextResponse:
    return GenerateTextResponse(
