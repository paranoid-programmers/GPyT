...
export class AuthApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * Login Via Github
     */
    public async loginViaGithubApiV1AuthLoginViaGithubPost(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // Path Params
        const localVarPath = '/api/v1/auth/login-via-github';
...
export class AuthApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to loginViaGithubApiV1AuthLoginViaGithubPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async loginViaGithubApiV1AuthLoginViaGithubPost(response: ResponseContext): Promise<any > {
