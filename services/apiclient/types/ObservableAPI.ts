...
export class ObservableCodeApi {
    private requestFactory: CodeApiRequestFactory;
    private responseProcessor: CodeApiResponseProcessor;
    private configuration: Configuration;
    ...
    public constructor(
        ...
        this.configuration = configuration;
        this.requestFactory = requestFactory || new CodeApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new CodeApiResponseProcessor();
    }
...
export class ObservableTutorialApi {
    private requestFactory: TutorialApiRequestFactory;
    private responseProcessor: TutorialApiResponseProcessor;
    private configuration: Configuration;
    ...
    public constructor(
        ...
        this.configuration = configuration;
        this.requestFactory = requestFactory || new TutorialApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new TutorialApiResponseProcessor();
    }
